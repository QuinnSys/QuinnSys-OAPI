...
% CO-AUTHOR: QuinnSys (the plot part)
...
UserPlot = input('Plot AutoCorrelation Chart?\n Y or N\n','s');
UserPlot = upper(UserPlot);
if UserPlot == 'Y'
    
    numMA = input('The amount of lags after which the theoretical ACF is considered to have died out? (default = 0)\n ');
    numSTD = input('The number of standard deviations?\n ');
    lags = (0:howManyR)';
    numLags = howManyR;
    acf  = rk';
